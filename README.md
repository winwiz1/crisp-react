...
> The SEO score of your website will be less than 100. You can improve it by changing the domain portion of the [`jamStackDeploymentUrl`](https://github.com/winwiz1/crisp-react/blob/master/client/webpack.config.js#L19) variable's value. Just point it to your per-project subdomain.
### AWS S3
